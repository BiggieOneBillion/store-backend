  ...
  return async (req, res, next) => {
    ...
    res.end = function(...args) {
      ...
      if (req.user && !options.skipAudit) {
        ...
        if (req.path.includes('/auth')) category = 'SECURITY';
        if (req.path.includes('/payment') || req.path.includes('/order')) category = 'FINANCIAL';
        if (req.path.includes('/stock') || req.path.includes('/product')) category = 'INVENTORY';
        ...
        auditService.logUserAction({
          ...
          entityId: req.params.id || req.params.userId || req.params.productId || req.params.orderId || req.params.storeId,
          metadata: {
